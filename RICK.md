# Personaje 1 — Científico excéntrico (mirada izquierda)
...
junto al del otro personaje ([MORTY.md](MORTY.md)). Cada prompt asume que
...
original (científico excéntrico), sin nombre ni referencia a ninguna obra
...
- Mirada siempre fija hacia la IZQUIERDA del cuadro, nunca a cámara.
...
cejas hundidas y un gesto marcado de la mano hacia su izquierda, los
...
mirada se queda siempre fija hacia la izquierda, nunca a cámara — en
...
fondo chroma verde, mirando siempre hacia la izquierda, nunca a cámara,
solo él en cuadro.
...
verde parejo, mirada fija siempre hacia la izquierda, nunca a cámara, sin
nadie más en cuadro.
...
centrado, fondo chroma verde, mirando siempre hacia la izquierda, nunca a
...
fondo verde parejo, mirada siempre hacia la izquierda, nunca a cámara,
nadie más en cuadro.
...
siempre hacia la izquierda, nunca a cámara, solo él en el cuadro.
...
fondo verde parejo, mirando siempre hacia la izquierda, nunca a cámara,
...
chroma verde, mirando siempre hacia la izquierda, nunca a cámara, solo
él en pantalla.
